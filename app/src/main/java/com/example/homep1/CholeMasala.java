...
public class CholeMasala extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l1=(TextView)findViewById(R.id.cmi) ;
        l2=(TextView)findViewById(R.id.cmd) ;
//give reference to view pager
        viewPager=(ViewPager)findViewById(R.id.viewPagercholemasala);
        //Give Refence to Class
        cholemasala= new PGCholeMasala(getSupportFragmentManager());
        viewPager.setAdapter(cholemasala);
